...
if (!$claims || !in_array(($claims['role'] ?? ''), ['Admin', 'Manager', 'User'], true)) {
...
<body>
  <h2>Dashboard</h2>
  <p>Welcome <?php echo htmlspecialchars((string) ($claims['name'] ?? 'User')); ?></p>
  <p>Role: <?php echo htmlspecialchars((string) ($claims['role'] ?? '')); ?></p>
